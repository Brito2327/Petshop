...
<body>
    ...
    <div class="card-deck">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>- Indicado para cães e gatos.
                    <br>- Previne o mau hálito.
                    <br>- Auxilia no combate do tártaro.
                    <br>- Promove higienização dos dentes.
        ...
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title">Creme Dental Cães e Gatos  </h5>
                <p class="font-weight-bold">Marca: Mundo Animal.</p>
                <p class="card-text">- Indicado para cães e gatos.
                    <br>- Promove uma higienização tranquila.
                    <br>- A bisnaga de 60g leva hexametafosfato de sódio na composição, que reduz o 
                    tártaro e o mau hálito.
                    <br>- A escovação é recomendada ao menos duas vezes por semana.
                </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">- Indicado para cães e gatos.
                    <br>- Fácil aplicação.
                    <br>- Ideal para a higienização bucal do pet.
    ...
    <div class="card-deck">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p>- Indicado para cães.
                    ...
                    <br>- Proteção que dura por 12 semanas.
                    <br>- Não sai com o banho.
                    <br>- Embalagem com 1 comprimido mastigável de 1400mg.
                </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">- Indicado para cães e gatos.
                    <br>- Possui ação anti-inflamatória, antirreumática e antialérgica.
                    <br>- Auxilia no tratamento de doenças dermatológicas, reumáticas, respiratórias e oftálmicas.
                    <br>- Também trata casos de otite externa e alergias.
                </p>
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <p class="card-text">- Atua como um poderoso antioxidante, melhorando as funções fisiológicas do 
                    organismo do animal.
                    <br>- Uso interno (gotas).
                    <br>- É composto por glicose e vitamina C.
                    <br>- Disponível em embalagem com 30ml.
                </p>
